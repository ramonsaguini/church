      ...
      <div className="d-flex justify-content-center align-items-center m-3">
        <div className='text-center text-decoration-none'>
          <Link to="/Manchester" className="text-decoration-none">
            <img src="./img/manah-logo-black.jpg" alt="manchester" className="circle-image img-locals" />
            <p className='black'>Manchester </p>
          </Link>
        </div>
        <div className='text-center text-decoration-none'>
          <Link to="/Liverpool" className="text-decoration-none">
            <img src="./img/manah-logo-black.jpg" alt="liverpool" className="circle-image img-locals" />
            <p className='black'>Liverpool</p>
          </Link>
        </div>
        <div className='text-center text-decoration-none'>
          <Link to="/Maceio" className="text-decoration-none">
            <img src="./img/manah-logo-black.jpg" alt="maceio" className="circle-image img-locals" />
